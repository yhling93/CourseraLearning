...
tmpTheta1 = Theta1(:,2:size(Theta1,2));
tmpTheta2 = Theta2(:,2:size(Theta2,2));
sum1 = sum((tmpTheta1.*tmpTheta1)(:));
sum2 = sum((tmpTheta2.*tmpTheta2)(:));
J = J/size(X,1) + lambda*(sum1+sum2)/(2*size(X,1));
